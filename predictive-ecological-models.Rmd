...
```
# Interlude: genAI and github copilot

We'll take a quick break from the course to look at how genAI can help us with making plots. Chris will demonstrate the github copilot tool. 
...
# Interlude: genAI and github copilot part 2 

We'll take a quick break from the course to look at how genAI can help us with ecological statistics. In particular, Chris wlil show how to use it to get robust statistical advice. You need to be a bit careful what you ask it. Good questions will get you good advice. Vague or poorly worded questions will get you inconsistent advice that may sometimes be wrong. 
